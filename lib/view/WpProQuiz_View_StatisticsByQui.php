 ...
 * @property array quizs
 * @property array quizsIDs
 */
class WpProQuiz_View_StatisticsByQui extends WpProQuiz_View_View
{
    ...
    private function showHistory()
    {
        ...
        <script type="text/javascript">
            console.log('<?php echo $this->quizsIDs; ?>');
            jQuery(document).ready(function ($) {
                $('#wpProQuiz_<?php echo $this->quiz->getId(); ?>').wpProQuizFront({
                    quizId: '<?php echo $this->quizsIDs; ?>',
