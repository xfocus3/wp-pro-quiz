...
class WpProQuiz_View_StatisticsAjax extends WpProQuiz_View_View
{
    ...
    public function showHistoryTable()
    {
        ...
        <table class="wp-list-table widefat">
            <thead>
            <tr style="background-color: #9BBB59!important; color: white;">
                <th scope="col" style="width: 200px;"><?php _e('Username', 'wp-pro-quiz'); ?></th>
            ...
            <tbody id="wpProQuiz_statistics_form_data">
                ...
                foreach ($this->historyModel as $model) {
                    ...
                    <tr>
                        ...
                        <th style="color: green;text-align: center;vertical-align: middle;"><?php echo $model->getQuizName(); ?></th>
