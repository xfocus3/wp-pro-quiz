 ...
 * @property WpProQuiz_Model_Quiz user
...
class WpProQuiz_View_FrontQuiz extends WpProQuiz_View_View
{
    ...
    private function loadButtonNames()
    {
        ...
        $names = array(
            ...
            'resume_quiz' => __('Resume quiz', 'wp-pro-quiz'),
            'stat_quiz' => __('History', 'wp-pro-quiz'),
        ...
        */
        ...
        <script type="text/javascript">
            ...
            window.wpProQuizInitList.push({
                ...
                init: {
                    quizId: <?php echo (int)$this->quiz->getId(); ?>,
                    currentUserId: <?php echo (int)$this->user->ID; ?>,
                    mode: <?php echo (int)$this->quiz->getQuizModus(); ?>,
                    globalPoints: <?php echo (int)$quizData['globalPoints']; ?>,
                    timelimit: <?php echo (int)$this->quiz->getTimeLimit(); ?>,
                    resultsGrade: <?php echo $resultsProzent; ?>,
        ...
        <div class="wpProQuiz_text">
            ...
            <div>
                <input class="wpProQuiz_button" type="button" value="<?php echo $this->_buttonNames['start_quiz']; ?>"
                       name="startQuiz">
                <input type="hidden" class="wpProQuiz_button" type="button" value="<?php echo $this->_buttonNames['resume_quiz']; ?>"
                       name="resumeQuiz">
                <input type="hidden" class="wpProQuiz_question_text" type="text" value="<?php echo $this->user->ID; ?>"
                       name="currentuserID">
            </div>
        </div>
        <?php
    ...
    private function showResultBox($result, $questionCount)
    {
        ...
        <div style="display: none;" class="wpProQuiz_results">
            ...
            <div style="margin: 10px 0px;">
                ...
                <?php } ?>
				<input class="wpProQuiz_button" type="button" name="filterHistory" 
                            value="<?php _e('Show History', 'wp-pro-quiz'); ?>">
    ...
    private function showHistory()
    {
        ...
        <div id="wpProQuiz_tabHistory" class="wpProQuiz_tabContent" style="display: block;">
            ...
            <div id="wpProQuiz_historyLoadContextNo"></div>

            <div style="margin-top: 10px;">

                <div style="float: left; display: none;" id="historyNavigation" >
